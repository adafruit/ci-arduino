...
export M4_PLATFORMS='declare -A m4_platforms=( [m4]="adafruit:samd:adafruit_metro_m4:speed=120,opt=small,maxspi=24,maxqspi=50", [trellis_m4]="adafruit:samd:adafruit_trellis_m4:speed=120,opt=small,maxspi=24,maxqspi=50" )'
