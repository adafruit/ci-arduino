...
ALL_PLATFORMS={
    ...
    ## ESP32-S2
    "magtag" : ["espressif:esp32:adafruit_magtag29_esp32s2", "0xbfdd4eee", "adafruit/wipper-3.1.3-idf-5.3"],
    "funhouse" : ["espressif:esp32:adafruit_funhouse_esp32s2", "0xbfdd4eee", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    "metroesp32s2" : ["espressif:esp32:adafruit_metro_esp32s2", "0xbfdd4eee", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    "qtpy_esp32s2" : ["espressif:esp32:adafruit_qtpy_esp32s2", "0xbfdd4eee", "adafruit/wipper-3.1.3-idf-5.3"],
    "feather_esp32s2" : ["espressif:esp32:adafruit_feather_esp32s2", "0xbfdd4eee", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    ## ESP32_S3
    "esp32s3_devkitc_1_n8" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,FlashMode=qio,PSRAM=disabled,USBMode=default,CDCOnBoot=cdc", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    "esp32s3_devkitc_1_n8_debug" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,FlashMode=qio,PSRAM=disabled,DebugLevel=verbose,USBMode=default,CDCOnBoot=cdc", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    "feather_esp32s3_4mbflash_2mbpsram" : ["espressif:esp32:adafruit_feather_esp32s3", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    "feather_esp32s3_tft" : ["espressif:esp32:adafruit_feather_esp32s3_tft", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    "feather_esp32s3_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    ...
    "xiao_esp32s3" : ["espressif:esp32:XIAO_ESP32S3:PartitionScheme=tinyuf2", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    # Adafruit AVR
