...
ALL_PLATFORMS={
    ...
    "espressif_esp32c5_devkitc_1_n8r4" : ["esp32:esp32:esp32c5:FlashMode=qio,FlashSize=8M,CDCOnBoot=cdc,CPUFreq=240,PSRAM=enabled,PartitionScheme=min_spiffs,DebugLevel=none", None, "adafruit/wipper-esp3.3.3"],
    "espressif_esp32c5_devkitc_1_n8r4_debug" : ["esp32:esp32:esp32c5:FlashMode=qio,FlashSize=8M,CDCOnBoot=cdc,CPUFreq=240,PSRAM=enabled,PartitionScheme=min_spiffs,DebugLevel=verbose", None, "adafruit/wipper-esp3.3.3"],
