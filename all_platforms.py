...
ALL_PLATFORMS={
    ...
    "esp32" : ["espressif:esp32:featheresp32:FlashFreq=80", None, "adafruit/bsp-3-3-11"],
    "itsybitsy_esp32" : ["espressif:esp32:adafruit_itsybitsy_esp32:FlashFreq=80", None, "adafruit/bsp-3-3-11"],
    ...
    "feather_esp32" : ["espressif:esp32:featheresp32:FlashFreq=80", None, "adafruit/bsp-3-3-11"],
    "wippersnapper_feather_esp32" : ["espressif:esp32:featheresp32:FlashFreq=80,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-11"],
    "feather_esp32_v2" : ["espressif:esp32:adafruit_feather_esp32_v2", None, "adafruit/bsp-3-3-11"],
    "qtpy_esp32" : ["espressif:esp32:adafruit_qtpy_esp32_pico", None, "adafruit/bsp-3-3-11"],
    "sparklemotion_esp32" : ["espressif:esp32:sparklemotion:PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-11"],
    "sparklemotionmini_esp32" : ["espressif:esp32:sparklemotionmini:PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-11"],
    "sparklemotionstick_esp32" : ["espressif:esp32:sparklemotionstick:PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-11"],
    ## ESP32-C3/C5/C6
    "dfrobot_beetle_esp32c3" : ["espressif:esp32:dfrobot_beetle_esp32c3:CDCOnBoot=cdc,CPUFreq=160,FlashFreq=80,FlashMode=qio,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-11"],
    ...
    "qtpy_esp32c3" : ["espressif:esp32:adafruit_qtpy_esp32c3:FlashMode=qio", None, "adafruit/bsp-3-3-11"],
    ...
    "funhouse_noota" : ["espressif:esp32:adafruit_funhouse_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "metroesp32s2" : ["espressif:esp32:adafruit_metro_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "metroesp32s2_debug" : ["espressif:esp32:adafruit_metro_esp32s2:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "qtpy_esp32s2" : ["espressif:esp32:adafruit_qtpy_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "feather_esp32s2" : ["espressif:esp32:adafruit_feather_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "feather_esp32s2_debug" : ["espressif:esp32:adafruit_feather_esp32s2:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "feather_esp32s2_tft" : ["espressif:esp32:adafruit_feather_esp32s2_tft:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "feather_esp32s2_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s2_tft:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    "feather_esp32s2_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s2_reversetft:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-11"],
    ## ESP32_S3
    "esp32s3_devkitc_1_n8" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,FlashMode=qio,PSRAM=disabled,USBMode=default,CDCOnBoot=cdc,LoopCore=1,EventsCore=1", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "esp32s3_devkitc_1_n8_debug" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,FlashMode=qio,PSRAM=disabled,DebugLevel=verbose,USBMode=default,CDCOnBoot=cdc,LoopCore=1,EventsCore=1", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3" : ["espressif:esp32:adafruit_feather_esp32s3_nopsram", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "wippersnapper_feather_esp32s3" : ["espressif:esp32:adafruit_feather_esp32s3_nopsram:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    ...
    # bootloader/tinyuf2 bins were added to the BSP in bsp-3-3-11 (f612cd7f).
    "lilygo_t_display_s3" : ["espressif:esp32:lilygo_t_display_s3:USBMode=default,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_debug" : ["espressif:esp32:adafruit_feather_esp32s3_nopsram:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "wippersnapper_feather_esp32s3_4mbflash_2mbpsram" : ["espressif:esp32:adafruit_feather_esp32s3:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_4mbflash_2mbpsram" : ["espressif:esp32:adafruit_feather_esp32s3:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_4mbflash_2mbpsram_debug" : ["espressif:esp32:adafruit_feather_esp32s3:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_tft" : ["espressif:esp32:adafruit_feather_esp32s3_tft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "wippersnapper_feather_esp32s3_tft" : ["espressif:esp32:adafruit_feather_esp32s3_tft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s3_tft:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "feather_esp32s3_reverse_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:DebugLevel=verbose", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "wippersnapper_feather_esp32s3_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "wippersnapper_feather_esp32s3_reverse_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "matrixportal_s3" : ["esp32:esp32:adafruit_matrixportal_esp32s3", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "metro_esp32s3" : ["espressif:esp32:adafruit_metro_esp32s3", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "metro_esp32s3_debug" : ["espressif:esp32:adafruit_metro_esp32s3:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "pycamera_s3" : ["esp32:esp32:adafruit_camera_esp32s3", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "qualia_s3_rgb666" : ["esp32:esp32:adafruit_qualia_s3_rgb666", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "qtpy_esp32s3" : ["espressif:esp32:adafruit_qtpy_esp32s3_nopsram", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "qtpy_esp32s3_n4r2" : ["espressif:esp32:adafruit_qtpy_esp32s3_n4r2:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-11"],
    "xiao_esp32s3" : ["espressif:esp32:XIAO_ESP32S3:PartitionScheme=tinyuf2,PSRAM=opi,FlashMode=qio,USBMode=default,DebugLevel=warn", "0xc47e5767", "adafruit/bsp-3-3-11"],
    # Adafruit AVR
