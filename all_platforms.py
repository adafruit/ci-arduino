...
ALL_PLATFORMS={
    ...
    "esp32" : ["espressif:esp32:featheresp32:FlashFreq=80", None, "adafruit/bsp-3-3-10"],
    "itsybitsy_esp32" : ["espressif:esp32:adafruit_itsybitsy_esp32:FlashFreq=80", None, "adafruit/bsp-3-3-10"],
    ...
    "feather_esp32" : ["espressif:esp32:featheresp32:FlashFreq=80", None, "adafruit/bsp-3-3-10"],
    "wippersnapper_feather_esp32" : ["espressif:esp32:featheresp32:FlashFreq=80,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    "feather_esp32_v2" : ["espressif:esp32:adafruit_feather_esp32_v2", None, "adafruit/bsp-3-3-10"],
    "qtpy_esp32" : ["espressif:esp32:adafruit_qtpy_esp32_pico", None, "adafruit/bsp-3-3-10"],
    "sparklemotion_esp32" : ["espressif:esp32:sparklemotion:PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    "sparklemotionmini_esp32" : ["espressif:esp32:sparklemotionmini:PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    "sparklemotionstick_esp32" : ["espressif:esp32:sparklemotionstick:PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    ## ESP32-C3/C5/C6
    "dfrobot_beetle_esp32c3" : ["espressif:esp32:dfrobot_beetle_esp32c3:CDCOnBoot=cdc,CPUFreq=160,FlashFreq=80,FlashMode=qio,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    "espressif_esp32c5_devkitc_1_n8r4" : ["espressif:esp32:esp32c5:FlashMode=qio,FlashSize=8M,CDCOnBoot=cdc,CPUFreq=240,PSRAM=enabled,PartitionScheme=min_spiffs,DebugLevel=none", None, "adafruit/bsp-3-3-10"],
    "espressif_esp32c5_devkitc_1_n8r4_debug" : ["espressif:esp32:esp32c5:FlashMode=qio,FlashSize=8M,CDCOnBoot=cdc,CPUFreq=240,PSRAM=enabled,PartitionScheme=min_spiffs,DebugLevel=verbose", None, "adafruit/bsp-3-3-10"],
    "feather_esp32c6" : ["espressif:esp32:adafruit_feather_esp32c6:FlashMode=qio", None, "adafruit/bsp-3-3-10"],
    "arduino_nesso_n1" : ["espressif:esp32:arduino_nesso_n1:PartitionScheme=huge_app", None, "adafruit/wipper-esp3.3.5-pre-c0395df"],
    "wippersnapper_feather_esp32c6" : ["espressif:esp32:adafruit_feather_esp32c6:CDCOnBoot=cdc,CPUFreq=160,FlashFreq=80,FlashMode=qio,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    "wippersnapper_feather_esp32c6_debug" : ["espressif:esp32:adafruit_feather_esp32c6:CDCOnBoot=cdc,DebugLevel=verbose,CPUFreq=160,FlashFreq=80,FlashMode=qio,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    "qtpy_esp32c3" : ["espressif:esp32:adafruit_qtpy_esp32c3:FlashMode=qio", None, "adafruit/bsp-3-3-10"],
    "wippersnapper_qtpy_esp32c3" : ["espressif:esp32:adafruit_qtpy_esp32c3:FlashMode=qio,PartitionScheme=min_spiffs", None, "adafruit/bsp-3-3-10"],
    ## ESP32-S2
    "magtag" : ["espressif:esp32:adafruit_magtag29_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "funhouse" : ["espressif:esp32:adafruit_funhouse_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "funhouse_noota" : ["espressif:esp32:adafruit_funhouse_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "metroesp32s2" : ["espressif:esp32:adafruit_metro_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "metroesp32s2_debug" : ["espressif:esp32:adafruit_metro_esp32s2:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "qtpy_esp32s2" : ["espressif:esp32:adafruit_qtpy_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "feather_esp32s2" : ["espressif:esp32:adafruit_feather_esp32s2:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "feather_esp32s2_debug" : ["espressif:esp32:adafruit_feather_esp32s2:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "feather_esp32s2_tft" : ["espressif:esp32:adafruit_feather_esp32s2_tft:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "feather_esp32s2_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s2_tft:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    "feather_esp32s2_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s2_reversetft:PartitionScheme=tinyuf2_noota", "0xbfdd4eee", "adafruit/bsp-3-3-10"],
    ## ESP32_S3
    "esp32s3_devkitc_1_n8" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,FlashMode=qio,PSRAM=disabled,USBMode=default,CDCOnBoot=cdc,LoopCore=1,EventsCore=1", "0xc47e5767", "adafruit/bsp-3-3-10"],
    ...
    # LilyGo T-Display-S3: the upstream espressif board entry defaults to
    # USBMode=hwcdc (usb_mode=1) — force USB-OTG (TinyUSB, usb_mode=0) to match
    # the WipperSnapper platformio env (ARDUINO_USB_MODE=0 + USE_TINYUSB, the
    # WIPPER MSC provisioning drive). The TinyUF2 16MB schemes + variant
    # bootloader/tinyuf2 bins were added to the BSP in bsp-3-3-10 (f612cd7f).
    "lilygo_t_display_s3" : ["espressif:esp32:lilygo_t_display_s3:USBMode=default,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    ...
    "feather_esp32s3_4mbflash_2mbpsram_debug" : ["espressif:esp32:adafruit_feather_esp32s3:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "feather_esp32s3_tft" : ["espressif:esp32:adafruit_feather_esp32s3_tft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "wippersnapper_feather_esp32s3_tft" : ["espressif:esp32:adafruit_feather_esp32s3_tft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "feather_esp32s3_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s3_tft:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "feather_esp32s3_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "feather_esp32s3_reverse_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:DebugLevel=verbose", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "wippersnapper_feather_esp32s3_reverse_tft" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "wippersnapper_feather_esp32s3_reverse_tft_debug" : ["espressif:esp32:adafruit_feather_esp32s3_reversetft:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "matrixportal_s3" : ["esp32:esp32:adafruit_matrixportal_esp32s3", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "metro_esp32s3" : ["espressif:esp32:adafruit_metro_esp32s3", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "metro_esp32s3_debug" : ["espressif:esp32:adafruit_metro_esp32s3:DebugLevel=verbose,PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "pycamera_s3" : ["esp32:esp32:adafruit_camera_esp32s3", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "qualia_s3_rgb666" : ["esp32:esp32:adafruit_qualia_s3_rgb666", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "qtpy_esp32s3" : ["espressif:esp32:adafruit_qtpy_esp32s3_nopsram", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "qtpy_esp32s3_n4r2" : ["espressif:esp32:adafruit_qtpy_esp32s3_n4r2:PartitionScheme=tinyuf2_noota", "0xc47e5767", "adafruit/bsp-3-3-10"],
    "xiao_esp32s3" : ["espressif:esp32:XIAO_ESP32S3:PartitionScheme=tinyuf2,PSRAM=opi,FlashMode=qio,USBMode=default,DebugLevel=warn", "0xc47e5767", "adafruit/bsp-3-3-10"],
    # Adafruit AVR
