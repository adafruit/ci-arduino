...
ALL_PLATFORMS={
    ...
    ## ESP32_S3
    "esp32s3_devkitc_1_n8" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,USBMode=default,CDCOnBoot=cdc", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
    "esp32s3_devkitc_1_n8_debug" : ["espressif:esp32:esp32s3:FlashSize=8M,PartitionScheme=noota_ffat,DebugLevel=verbose,USBMode=default,CDCOnBoot=cdc", "0xc47e5767", "adafruit/wipper-3.1.3-idf-5.3"],
