...
ALL_PLATFORMS={
    ...
    "magtag_tinyusb" : ["esp32:esp32:adafruit_magtag29_esp32s2:CDCOnBoot=cdc,MSCOnBoot=default,DFUOnBoot=default,PSRAM=enabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=none", "0xbfdd4eee"],
    "funhouse_tinyusb" : ["esp32:esp32:adafruit_funhouse_esp32s2:CDCOnBoot=cdc,MSCOnBoot=default,DFUOnBoot=default,PSRAM=enabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=none", "0xbfdd4eee"],
    "metro_s2_tinyusb" : ["esp32:esp32:adafruit_metro_esp32s2:CDCOnBoot=cdc,MSCOnBoot=default,DFUOnBoot=default,PSRAM=enabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=none", "0xbfdd4eee"],
    "feather_s2_tinyusb" : ["esp32:esp32:adafruit_feather_esp32s2:CDCOnBoot=cdc,MSCOnBoot=default,DFUOnBoot=default,PSRAM=enabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=verbose", "0xbfdd4eee"],
    "qtpy_esp32_s2" : ["esp32:esp32:adafruit_qtpy_esp32s2:CDCOnBoot=cdc,MSCOnBoot=default,DFUOnBoot=default,PSRAM=enabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=verbose", "0xbfdd4eee"],
    "feather_s2_tft_tinyusb" : ["esp32:esp32:adafruit_feather_esp32s2_tft:CDCOnBoot=cdc,MSCOnBoot=default,DFUOnBoot=default,PSRAM=enabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=verbose", "0xbfdd4eee"],
    # Adafruit AVR
